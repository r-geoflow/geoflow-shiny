...
RUN R -e "install.packages(c('shinyvalidate'), repos='https://cran.r-project.org/')"
...
RUN R -e "install.packages(c('rhandsontable'), repos='https://cran.r-project.org/')"
RUN R -e "install.packages(c('fastmap'), repos='https://cran.r-project.org/')"
RUN R -e "install.packages(c('magrittr'), repos='https://cran.r-project.org/')"
RUN R -e "install.packages(c('promises'), repos='https://cran.r-project.org/')"
RUN R -e "install.packages(c('future'), repos='https://cran.r-project.org/')"
RUN R -e "install.packages(c('ipc'), repos='https://cran.r-project.org/')"
